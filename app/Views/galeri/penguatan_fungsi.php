...
<div class="row">
  ...
  <div class="col-6 mt-4">
    <?= form_open('galeri/penguatan_fungsi/filter') ?>
          ...
          <div class="card-body px-1">
            ...
            <div class="letest-news">
              <div class="single-post my-1">
                <div class="col-6">
                  <?php if (!empty($pf->file_pks)) { ?>
                    <img data-pdf-thumbnail-file="<?= base_url('uploads/penguatan_fungsi/file/' . $pf->file_pks) ?>">
                  <?php } else { ?>
                    <img src="<?= base_url('assets/images/no_image.png') ?>" alt="post thumb">
                  <?php } ?>
                </div>
                <div class="col-6">
                  <i class="fa fa-calendar"> <?= tgl_indo($pf->tgl_awal) . " - " . tgl_indo($pf->tgl_akhir) ?></i>
                  <b><?= $pf->judul ?></b>
                  <a href="<?= base_url('galeri/penguatan_fungsi/info/' . $pf->id) ?>" class="badge badge-info">Detail</a>
                </div>
              </div>
            </div>
          </div>
