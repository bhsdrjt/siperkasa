...
<!-- <div class="main-content-inner">
  <div class="container"> -->
    <div class="row">
      ...
      <div class="col-6 mt-4">
        <?= form_open('galeri/pembangunan_strategis/filter') ?>
      ...
      <?php if (!empty($pembangunan_strategis)) {
              ...
              <div class="card-body px-1">
                ...
                <div class="letest-news">
                  <div class="single-post my-1">
                    ...
                    <div class="col-6">
                      <i class="fa fa-calendar"> <?= tgl_indo($ps->tgl_awal) . " - " . tgl_indo($ps->tgl_akhir) ?></i>
                      <b><?= $ps->judul ?></b>
                      <a href="<?= base_url('galeri/pembangunan_strategis/info/' . $ps->id) ?>" class="badge badge-info">Detail</a>
                    </div>
                  </div>
                </div>
              </div>
