            ...
            <div class="row">
              ...
              <div class="col-5">
                <span class="float-right">
                  <a href="<?= base_url('kerja_sama/pembangunan_strategis_skw/add') ?>" class="btn btn-xs btn-outline-primary"><i class="fa fa-plus"></i> Tambah</a>
                </span>
              </div>
            </div>
          </div>
                    ...
                    foreach ($kerja_sama as $data) { ?>
                      <tr>
                        ...
                        <!-- <td><?php /*if (isset($data->file_spt)) { ?>
                            <img data-pdf-thumbnail-file="<?= base_url('uploads/pembangunan_strategis_skw/file/' . $data->file_spt) ?>" data-pdf-thumbnail-width="100">
                          <?php  } */ ?>
                        </td> -->
                        <td>
                          <a href="<?= base_url('kerja_sama/pembangunan_strategis_skw/edit/' . $data->id) ?>" class="btn btn-xs btn-outline-warning"><i class="fa fa-file-text-o"></i></a>
...
<div class="modal fade" id="modal-deleteSKW" style="display: none;" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?= form_open('kerja_sama/pembangunan_strategis_skw/process/delete') ?>
