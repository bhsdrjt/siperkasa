      ...
      <div class="col-12 mt-3">
        <div class="card">
          <div class="card-header bg-warning text-white">
            <div class="row">
              <div class="col-7">
                <h4>Kerja Sama Penguatan Fungsi SKW Edit</h4>
              </div>
              <div class="col-5">
          ...
          <div class="card-body">
            ...
            <?= form_open('kerja_sama/penguatan_fungsi_skw/process/edit', 'enctype="multipart/form-data"') ?>
            <input type="hidden" name="id" value="<?= isset($penguatanFungsi) ? $penguatanFungsi->id : 0 ?>">
            ...
            <div class="row">
                ...
                <select class="form-control" name="mitra" id="mitra" required>
                  ...
                  <?php if (isset($mitra)) {
                    foreach ($mitra as $mit) {
                      ...
                      echo $mit->id_mitra == $penguatanFungsi->id_mitra ? 'selected' : '';
                ...
                <select class="form-control" name="rkt" id="rkt" required>
                  ...
                  <?php if (isset($rkt)) {
                    foreach ($rkt as $data) {
                      ...
                      echo $data->id == $penguatanFungsi->id_rkt ? 'selected' : '';
              ...
              <div class="form-group col-12">
                ...
                <input class="form-control" type="text" name="judul" id="judul" placeholder="Judul" value="<?= $penguatanFungsi->judul_laporan ?>">
              </div>


              <div class="form-group col-4">
                <label for="file_laporan" class="col-form-label"><b>Laporan Kerja Sama</b> <sup style="color: darkblue;">(Pdf)</sup></label>
                <?php if (!empty($penguatanFungsi->file_laporan)) { ?>
                  <a href="<?= base_url('uploads/penguatan_fungsi_skw/file/' . $penguatanFungsi->file_laporan) ?>" class="btn btn-link float-right" target="_blank">Lihat</a>
                <?php } ?>
              ...
              <div class="form-group col-4">
                ...
                <?php if (!empty($penguatanFungsi->file_spt)) { ?>
                  <a href="<?= base_url('uploads/penguatan_fungsi_skw/file/' . $penguatanFungsi->file_spt) ?>" class="btn btn-link float-right" target="_blank">Lihat</a>
                <?php } ?>
                <div class="input-group mb-3">
                      ...
                      foreach ($dokumentasi as $dok) { ?>
                        <tr>
                          ...
                          <td style="padding-left: 0px;">
                            <a href="<?= base_url('uploads/penguatan_fungsi_skw/dokumentasi/' . $dok->gambar) ?>" class="btn btn-link" target="_blank"><?= $dok->gambar ?></a>
